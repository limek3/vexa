...
const FALLBACK_APPOINTMENTS: AppointmentItem[] = [
  ...
  },
  {
    ...
    service: 'Педикюр',
    price: 3100,
    avatar: 'https://images.unsplash.com/photo-1548142813-c348350df52b?auto=format&fit=crop&w=96&q=80',
    tone: 'peach',
  },
];
...
function rub(value: number) {
  ...
  return currencyFormatter.format(Math.round(normalized)).replace('₽', '₽');
}
  ...
  return [
    {
      ...
      tone: 'peach',
      items: [
        { name: 'Наталья Орлова', role: 'Стрижка', date: '20.05', time: '10:00', avatar: source[0]?.avatar },
        { name: 'Игорь Петров', role: 'Массаж', date: '20.05', time: '11:30', avatar: source[3]?.avatar },
      ],
      extra: '+ Ещё 6 записей',
    },
    {
      ...
      tone: 'cream',
      items: [
        { name: 'Светлана Миронова', role: 'Маникюр', date: '19.05', time: '16:00', avatar: source[1]?.avatar },
        { name: 'Антон Лазарев', role: 'Стрижка', date: '19.05', time: '17:30', avatar: source[3]?.avatar },
      ],
    ...
    },
    {
      ...
      tone: 'sky',
      items: [
        { name: 'Анна Кузнецова', role: 'Стрижка', time: '12:30', avatar: source[2]?.avatar },
        { name: 'Павел Котов', role: 'Бритьё', time: '13:15', avatar: source[3]?.avatar },
      ],
      extra: '+ Ещё 3 записи',
    },
  ];
    ...
    team: [
      {
        ...
        progress: 128,
        revenue: 72300,
        avatar: displaySchedule[0]?.avatar,
      },
      {
        name: 'Ольга',
        ...
        progress: 96,
        revenue: 54800,
        avatar: displaySchedule[4]?.avatar,
      },
      {
        name: 'Игорь',
        role: 'Массажист',
        progress: 87,
        revenue: 41600,
        avatar: displaySchedule[3]?.avatar,
      },
    ],
    messages: [
      {
        ...
        time: '16:42',
        avatar: displaySchedule[1]?.avatar,
      },
      {
        name: 'Наталья Орлова',
        text: 'Спасибо за стрижку! Всё супер! 🌸',
        time: '15:10',
        avatar: displaySchedule[2]?.avatar,
      },
    ],
    review: {
      name: 'Анна Кузнецова',
...
function PremiumCard({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <section
      className={cn(
        'rounded-[26px] border border-[#eadfd5]/80 bg-white/92 shadow-[0_18px_55px_rgba(24,17,12,0.055)] backdrop-blur',
        className,
      )}
    >
      {children}
...
function TopNavigation({ model }: { model: DashboardModel }) {
  return (
    <header className="relative z-40 border-b border-[#eee6de] bg-white/94 backdrop-blur-xl">
        ...
        <div className="ml-auto hidden items-center gap-3 lg:flex">
          ...
          <button className="flex items-center gap-3 rounded-full py-1 pl-1 pr-2 transition-colors hover:bg-[#fff6ef]">
            ...
            <span className="hidden text-left 2xl:block">
              ...
              <span className="block text-[11px] text-[#8c8c95]">Владелец</span>
            </span>
...
function AiInsightCard() {
  return (
    <section className="relative min-h-[186px] overflow-hidden rounded-[24px] border border-[#e6ecd5] bg-[#f5faec] p-7 shadow-[0_16px_45px_rgba(60,84,43,0.07)]">
      ...
      <div className="absolute right-10 top-8 flex size-24 2xl:right-12 2xl:size-28 items-center justify-center rounded-full bg-[#b8dc9a] shadow-[inset_0_0_0_14px_rgba(255,255,255,0.28)]">
...
function BookingPipeline({ model }: { model: DashboardModel }) {
  return (
    <PremiumCard className="p-5 2xl:p-6">
      <h2 className="mb-4 2xl:mb-5 text-[15px] font-bold text-[#071b3a]">Конвейер записей</h2>
...
function GoalCard() {
  return (
    <section className="relative min-h-[222px] overflow-hidden rounded-[26px] border border-[#f2d8c7] bg-[#fff1e8] p-6 2xl:min-h-[242px] 2xl:p-7 shadow-[0_18px_55px_rgba(24,17,12,0.055)]">
      <div className="absolute bottom-0 right-4 hidden h-[190px] w-[170px] opacity-75 xl:block">
        <div className="absolute bottom-0 right-10 h-16 w-20 rounded-t-[40px] bg-[#d8b990]" />
        <div className="absolute bottom-12 right-6 h-32 w-20 -rotate-12 rounded-full bg-[#c8b89b]/55" />
        <div className="absolute bottom-24 right-20 h-28 w-16 rotate-12 rounded-full bg-[#d7c7aa]/60" />
      </div>
...
function BottomMobileNav() {
  return (
    <nav className="fixed inset-x-4 bottom-4 z-40 grid grid-cols-5 rounded-[24px] border border-[#eadfd5] bg-white/92 p-2 shadow-[0_18px_55px_rgba(24,17,12,0.16)] backdrop-blur lg:hidden">
      {[
