...
import { appointmentStatuses, createInitialState, durationLabel, formatMoney, masterProfile, navSections, safeParseDesktopState, screenLabels, screenPaths } from './desktop-data';
import { renderPage } from './desktop-pages';
import type { Appointment, AppointmentStatus, DesktopState, Preferences, ScreenId } from './desktop-types';
import { Avatar, Badge, Button, Field, Icon, Input, cn } from './desktop-ui';
