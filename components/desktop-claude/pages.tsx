...
import type { Appointment, AppointmentStatus, Client, ClientStatus, DesktopState, Preferences, ScreenId, Service } from './types';
import {
  accentOptions,
  appointmentStatuses,
  clientStatuses,
...
import { Avatar, Badge, Button, Card, EmptyState, Field, Icon, Input, Metric, PageHeader, Progress, Segmented, Spark, Switch, Tabs, Textarea, cn } from './ui';
