...
-- =============================================================
-- 20260502_0021_clickbook_vk_classic_oauth.sql
-- =============================================================
-- ClickBook VK classic OAuth auth. Ensures the optional VK account table exists
-- for oauth.vk.com login. Safe to run even if 0020 was already applied.
...
-- 20260502_0024_clickbook_vk_bot_send_diagnostics.sql
...
-- 20260503_0031_clickbook_telegram_chat_id_and_chat_delete_fix.sql
update public.sloty_telegram_accounts a
set
  chat_id = coalesce(
    a.chat_id,
    (
      select r.chat_id
      from public.sloty_telegram_login_requests r
...
-- 20260503_0032_clickbook_booking_context_threads.sql
...
-- 20260503_0033_clickbook_multi_booking_context_ui.sql
...
begin
  if to_regclass('public.sloty_chat_threads') is not null
    ...
    where t.workspace_id = b.workspace_id
      and (
        t.metadata->>'bookingId' = b.id::text
        or t.id = ('booking-thread-' || b.id::text)
      );
  end if;
end $$;
