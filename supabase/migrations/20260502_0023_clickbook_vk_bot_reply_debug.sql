-- ClickBook VK bot reply/debug hardening
-- Adds a safe debug log for VK Callback API events so we can see whether VK
-- actually reaches /api/vk/webhook and what ref/text it sends.
